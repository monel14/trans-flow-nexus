-- =====================================================
-- PHASE 2 : FONCTIONS RPC POUR CRÉATION HIÉRARCHIQUE
-- =====================================================

-- Fonction utilitaire pour valider les formats d'identifiants
...
-- =====================================================
-- 1. FONCTION: create_chef_agence
-- Appelée par: Admin Général uniquement
-- =====================================================
...
BEGIN
    ...
    -- ÉTAPE 6: MISE À JOUR DE L'AGENCE (assigner le chef)
...
BEGIN
    ...
    INSERT INTO public.profiles (
        ...
        identifier_in,
        full_name_in,
        NULL, -- Sous-admin n'est pas lié à une agence spécifique
        true,
        0,
        NOW(),
        NOW()
...
-- =====================================================
-- 3. FONCTION: create_agent
-- Appelée par: Chef d'Agence uniquement
-- =====================================================
...
BEGIN
    ...
    INSERT INTO public.profiles (
        ...
        identifier_in,
        full_name_in,
        calling_user_agency_id, -- Agent créé dans l'agence du chef
        true,
        0, -- Solde initial à zéro
        NOW(),
        NOW()
    );
...
-- =====================================================
-- FONCTION UTILITAIRE: Créer un admin initial
-- À utiliser une seule fois pour bootstrapper le système
-- =====================================================
