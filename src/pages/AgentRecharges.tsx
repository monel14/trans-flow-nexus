...
const AgentRecharges = () => {
  ...
  const handleApprove = async (request: any) => {
    if (!request.requested_amount) {
      toast({
        title: "Erreur",
        description: "Le montant de la demande n'est pas défini",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      await updateRequest.mutateAsync({
        ...
        updates: {
          ...
          resolution_notes: resolutionNotes || 'Demande approuvée et solde crédité',
        }
      });

      // 2. Créer une transaction pour créditer le solde
      ...
      toast({
        ...
        description: `Recharge de ${formatAmount(request.requested_amount)} approuvée avec succès`,
      });
